            ...
            <form class="space-y-5" action="{{ route('login') }}" method="POST">
                ...
                <div class="flex items-center justify-between py-1">
                    <label class="relative inline-flex items-center cursor-pointer select-none">
                        ...
                        <div class="w-4 h-4 rounded border border-slate-300 peer-checked:bg-emerald-700 peer-checked:border-emerald-700 flex items-center justify-center">
                ...
                <!-- Google SSO Button -->
                <button type="button" class="w-full py-2.5 rounded-xl border border-slate-200 bg-white text-slate-700 font-bold text-xs hover:bg-slate-50 transition-colors flex items-center justify-center gap-2 shadow-xs">
                ...
                <div class="text-center pt-2">
                    <p class="text-xs text-slate-500 font-medium">
                        ...
                        <a href="{{ route('register') }}" class="font-bold text-emerald-700 hover:text-emerald-800">Create Account</a>
                    </p>
                </div>
            </form>
