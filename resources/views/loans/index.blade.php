                    ...
                    <tr class="hover:bg-slate-50/80 dark:hover:bg-slate-800/40 transition-colors">
                        ...
                        <td class="py-4 px-6">
                            <span class="px-2.5 py-0.5 rounded text-[11px] font-extrabold uppercase tracking-wider
                                @if($loan->status === 'pending') bg-amber-100 dark:bg-amber-950/60 text-amber-800 dark:text-amber-300 border border-amber-200 dark:border-amber-800
                                @elseif($loan->status === 'open_funding') bg-blue-100 dark:bg-blue-950/60 text-blue-800 dark:text-blue-300 border border-blue-200 dark:border-blue-800
                                ...
                                @else bg-rose-100 dark:bg-rose-950/60 text-rose-800 dark:text-rose-300 border border-rose-200 dark:border-rose-800 @endif">
