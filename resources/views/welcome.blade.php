...
<body class="bg-slate-50 text-slate-900 font-sans antialiased min-h-screen flex flex-col justify-between">
    ...
    <main class="flex-grow space-y-24 py-12">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div class="lg:col-span-6 space-y-6">
                    ...
                    <div class="flex items-center gap-3 pt-2">
                        ...
                        <a href="#features" class="py-3 px-6 rounded-xl border border-slate-200 bg-white text-slate-700 text-xs font-bold hover:bg-slate-50 transition-colors shadow-xs">
                            Learn More
                        </a>
                    </div>
                </div>
        ...
        <!-- ─── Section 3: Features & Calculator (#features) ──────────────────── -->
