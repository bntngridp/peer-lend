                        ...
                        <tr class="group hover:bg-slate-50/60 dark:hover:bg-slate-800/40 transition-colors duration-150">
                            ...
                            <td class="whitespace-nowrap px-4 py-4">
                                @if($loan->isCryptoLoan())
                                    <span class="inline-flex items-center gap-1 rounded-lg bg-indigo-500/10 border border-indigo-500/25 px-2 py-0.5 text-xs font-semibold text-indigo-400">
                                        <svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M20.25 6.375c0 8.485-7.5 11.625-7.5 11.625S5.25 14.86 5.25 6.375a7.5 7.5 0 0 1 15 0Z"/></svg>
