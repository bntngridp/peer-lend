                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-800 font-semibold text-slate-800 dark:text-slate-200">
                    @forelse($kycs as $kyc)
                        <tr class="hover:bg-slate-50/60 dark:hover:bg-slate-800/40 transition-colors">
                            ...
                            <td class="py-4 px-6">
                                @if($kyc->isRejected())
                                    <span class="px-2.5 py-1 rounded-md text-[10px] font-bold bg-rose-50 dark:bg-rose-950/60 text-rose-700 dark:text-rose-300 border border-rose-200 dark:border-rose-800/80 uppercase">
                                        {{ __('HIGH') }}
                                    </span>
                                @elseif($kyc->isApproved())
                                    <span class="px-2.5 py-1 rounded-md text-[10px] font-bold bg-emerald-50 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800/80 uppercase">
                                        {{ __('LOW') }}
                                    </span>
                                @else
                                    <span class="px-2.5 py-1 rounded-md text-[10px] font-bold bg-amber-50 dark:bg-amber-950/60 text-amber-700 dark:text-amber-300 border border-amber-200 dark:border-amber-800/80 uppercase">
                                        {{ __('MEDIUM') }}
                                    </span>
                                @endif
                            </td>
