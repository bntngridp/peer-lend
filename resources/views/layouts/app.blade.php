                    ...
                    @auth
                        ...
                        <div class="relative" x-data="{ langOpen: false }">
                            ...
                            <div x-show="langOpen" @click.away="langOpen = false" x-cloak class="absolute right-0 mt-2 w-44 rounded-2xl bg-white dark:bg-slate-900 shadow-xl ring-1 ring-black/5 dark:ring-slate-800 z-50 py-1.5">
                                <a href="{{ route('lang.switch', ['locale' => 'id', 'redirect' => request()->fullUrl()]) }}" class="flex items-center justify-between px-4 py-2 text-xs font-medium {{ app()->getLocale() === 'id' ? 'bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 font-bold' : 'text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800' }}">
                                    <span>Bahasa Indonesia</span> <span class="text-[10px] text-slate-400">ID</span>
                                </a>
                                <a href="{{ route('lang.switch', ['locale' => 'en', 'redirect' => request()->fullUrl()]) }}" class="flex items-center justify-between px-4 py-2 text-xs font-medium {{ app()->getLocale() === 'en' ? 'bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 font-bold' : 'text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800' }}">
                                    <span>English</span> <span class="text-[10px] text-slate-400">EN</span>
                                </a>
                                <a href="{{ route('lang.switch', ['locale' => 'es', 'redirect' => request()->fullUrl()]) }}" class="flex items-center justify-between px-4 py-2 text-xs font-medium {{ app()->getLocale() === 'es' ? 'bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 font-bold' : 'text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800' }}">
                                    <span>Español</span> <span class="text-[10px] text-slate-400">ES</span>
                                </a>
                                <a href="{{ route('lang.switch', ['locale' => 'ar', 'redirect' => request()->fullUrl()]) }}" class="flex items-center justify-between px-4 py-2 text-xs font-medium {{ app()->getLocale() === 'ar' ? 'bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 font-bold' : 'text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800' }}">
